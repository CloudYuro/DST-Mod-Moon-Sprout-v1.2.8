...
local function teleportahead(inst,pos)
    local nub = SpawnPrefab("wormwood_lunarthrall_plant_vine")
...
local WEAKVINE_CAN = {"weakvine","wormwood_lunarplant"}

local MUST_TAGS =  {"_combat"}
local CANT_TAGS = { "player", "wormwood_pet", "wormwood_lunarplant", "companion", "FX", "NOCLICK", "DECOR", "INLIMBO", "invisible", "wall", "notarget", "noattack", }
