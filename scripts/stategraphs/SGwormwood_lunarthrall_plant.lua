...
local AOE_TARGET_CANT_TAGS = { "character", "wormwood_pet", "wormwood_lunarplant", "INLIMBO", "invisible", "notarget", "wall", "noattack", "lunarthrall_plant", "lunarthrall_plant_end" }
