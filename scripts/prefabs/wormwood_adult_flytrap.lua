local SGwormwood_adultflytrap = require("stategraphs/SGwormwood_adultflytrap")
...
local brain = require("brains/wormwood_adultflytrapbrain")
...
local function fn()
    ...
    inst:SetBrain(brain)
    inst:SetStateGraph("SGwormwood_adultflytrap")
...
return Prefab("wormwood_adult_flytrap", fn, assets, prefabs)
