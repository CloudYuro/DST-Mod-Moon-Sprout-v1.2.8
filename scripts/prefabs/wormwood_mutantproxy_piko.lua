...
local function MakeProxy(prefabname, product)
    ...
    local function proxy_fn()
        ...
        inst.AnimState:SetMultColour(1.0, 0.4, 1.0, 1)
...
return MakeProxy("wormwood_mutantproxy_piko", "wormwood_piko"),
    MakeProxy("wormwood_mutantproxy_piko_orange", "wormwood_piko_orange")